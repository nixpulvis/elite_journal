...
//! back entries in the order the files hold them and `galos_index::galaxy`
...
/// `--from journal=DIR` reads a directory by, in either of the tools that
/// takes it.
